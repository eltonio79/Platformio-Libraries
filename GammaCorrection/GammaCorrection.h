...
#if FADE_LED_PWM_BITS == 7
/* 101-step brightness table: gamma = 2.3 for 8-bit PWM*/ 
const unsigned int FadeACGammaTable[101] PROGMEM = {
    128, 125, 122, 120, 117,
    114, 112, 109, 107, 104, 102, 100, 97,
    95,  93,  90,  88,  86,  84,  82,  79,
    77,  75,  73,  71,  69,  67,  66,  64,
    62,  60,  58,  57,  55,  53,  52,  50,
...
#elif FADE_LED_PWM_BITS == 8
/* 101-step brightness table: gamma = 2.3 for 8-bit PWM*/ 
const unsigned int FadeLedGammaTable[101] PROGMEM = {
    0, 1, 1, 1, 1, 2, 2, 2,
    3, 3, 4, 4, 5, 5, 6, 7,
