...
#if (OUTPUT_STEREO_HACK == true)
#warning Use of OUTPUT_STEREO_HACK is deprecated. Use AUDIO_CHANNELS OUTPUT_STEREO, instead.
...
// define MICROS_PER_AUDIO_TICK which is used for mozziMicros()
#if AUDIO_RATE == 16384
...
// MICROS_PER_AUDIO_TICK support for other any AUDIO_RATE
#ifndef MICROS_PER_AUDIO_TICK
...
#include "PlatformMBED.h"
#include "PlatformRP2040.h"
#include "PlatformRP2040_I2S.h"
#include "PlatformAVR.h"
#include "PlatformESP32_I2S.h"
#include "PlatformESP8266.h"
#include "PlatformSAMD21.h"
#include "PlatformTeensy3.h"
#include "PlatformSTM32.h"
#include "PlatformLinuxPulseAudio.h"
