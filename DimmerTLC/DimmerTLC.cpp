...
{
    unsigned int rawValueMap = DimmerTLC::RAW_VALUE_MIN, rawValueTab = DimmerTLC::RAW_VALUE_MIN;
    rawValueMap = map(_value, DimmerEx::VALUE_MIN, DimmerEx::VALUE_MAX, DimmerTLC::RAW_VALUE_MIN, DimmerTLC::RAW_VALUE_MAX);
    Serial.print("From map: ");
    Serial.println(rawValueMap);
    rawValueTab = FadeLedGammaTable[_value];
